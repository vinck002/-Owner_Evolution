    ...
    public partial class Settlement : Form
    {
        ...
        private void ReportToThird_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DAV = SQLCMD.SQLdata($"LS_SUMMARYPAYMENTREPORT_M '{AllAgreementID}'").DefaultView;

                //DAV = SQLCMD.SQLdata($"LS_SUMMARYPAYMENTREPORT_L {Salesfloorid.Text},'{((Contractdate1.Text == "") ? "01-01-1990" : Contractdate1.Text)}','{Contractdate2.Text}',1,500000,'1111',null,1,'{AllAgreementID.ToString()}',1").DefaultView;
                /*----------------------------------------*/
