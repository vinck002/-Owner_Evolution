...
namespace Evolution.General
{
    public static class ExportGlobaliaComision
    {
        ...
        {/*----------------------------------------------------------------------------------------*/
            ...
            Microsoft.Office.Interop.Excel.Range formatcolunD = aplicacion.Worksheets.get_Item(2).Range[$"D3:D{dt.Rows.Count}"];
            ...
            //************************************modificado por melvin para el nuvo procedimiento
          ...
          ///////////////////////////////////////////**PINTAR LAS FILAS QUE CONTIENE LA PALABRA "MEMBERSHIP PRICE"**////////////////////////////////////////////////////
            foreach (var item in rowTotales)
            {
                ...
                //RngMemberShipPrice.HorizontalAlignment = XlHAlign.xlHAlignCenter;
                //RngMemberShipPrice.WrapText = true;
                RngMemberShipPrice.RowHeight = 25.50;
            }
            Range rngTotales = aplicacion.Worksheets.get_Item(2).Range["A6"];
            rngTotales.NumberFormat = "#,##0.00";
